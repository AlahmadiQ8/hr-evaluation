...
resource script_sql_evaluationdb 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'evaluationdb', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
